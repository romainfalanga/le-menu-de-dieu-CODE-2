...
interface GodCodingSimulationProps {
  isPaused: boolean;
  resetTrigger: number;
}

const GodCodingSimulation: React.FC<GodCodingSimulationProps> = ({ isPaused, resetTrigger }) => {
  ...
  }, [isTyping, isDeleting, currentCode, sequenceIndex, binarySequences, isPaused]);

  // Effet pour gérer la réinitialisation
  useEffect(() => {
    if (resetTrigger > 0) {
      setCurrentCode('');
      setIsTyping(false);
  ...
  return (
    <div className="bg-black/80 backdrop-blur-sm rounded-xl p-4 sm:p-6 border-2 border-yellow-400/50 shadow-2xl min-h-[424px] min-w-[444px] mx-auto">
      ...
      <div className="bg-gray-900 rounded-lg p-4 font-mono text-green-400 min-h-[332px] min-w-[396px]">
...
export const GodCodesInBinaryPage: React.FC = () => {
  ...
  const [resetSimulationTrigger, setResetSimulationTrigger] = useState(0);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 relative z-10">
        ...
        <div className="max-w-xl mx-auto mb-8 lg:mb-12">
          <GodCodingSimulation 
            ...
            resetTrigger={resetSimulationTrigger}
          />
          ...
          <div className="flex justify-center gap-4 mt-4">
            <button
              ...
              className="flex items-center justify-center px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg"
            >
              {isSimulationPaused ? (
                <>
            ...
            <button
              onClick={() => setResetSimulationTrigger(prev => prev + 1)}
              className="flex items-center justify-center px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg"
            >
              <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
