...
const GodCodingSimulation: React.FC = () => {
  ...
  return (
    <div className="bg-black/80 backdrop-blur-sm rounded-xl p-4 sm:p-6 border-2 border-yellow-400/50 shadow-2xl w-fit min-w-[580px] sm:min-w-[680px] mx-auto h-[438px] sm:h-[504px]">
