...
const GodCodingSimulation: React.FC = () => {
  ...
  return (
    <div className="bg-black/80 backdrop-blur-sm rounded-xl p-4 sm:p-6 border-2 border-yellow-400/50 shadow-2xl w-fit min-w-[415px] sm:min-w-[486px] mx-auto h-[438px] sm:h-[504px]">
      ...
      <div className="bg-gray-900 rounded-lg p-4 font-mono text-green-400 w-full h-[280px] sm:h-[340px] overflow-hidden">
        <pre className="text-xs sm:text-sm whitespace-pre leading-tight overflow-x-auto break-all">
          {currentCode}
