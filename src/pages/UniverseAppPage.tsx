            ...
            <div className="w-full flex items-start justify-center p-2 sm:p-4 pt-2">
              <div className="max-w-4xl mx-auto w-full text-center">
                ...
                <div className="bg-gradient-to-br from-emerald-900/50 to-teal-900/40 backdrop-blur-sm rounded-xl p-3 sm:p-4 border-2 border-emerald-400/40 shadow-2xl mb-3 sm:mb-4">
                  ...
                  {/* Rendu des échelles avec connexions horizontales */}
                  {sections.slice(1).map((section, index) => (
                    <React.Fragment key={section.id}>
                      {/* Transition vers la Superposition Quantique - avant l'échelle atomique */}
                      {section.id === 2 && (
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
                        ...
                        <div className="space-y-3 lg:order-1">
                          ...
                          <div className="p-2 sm:p-3 rounded-lg border-l-4 bg-purple-900/40 border-purple-400 min-h-[60px] sm:min-h-[70px] flex flex-col justify-center">
                            ...
                            <div className="text-gray-300 text-xs mt-1">{section.content.universe}</div>
                            {section.content.universeExamples && (
                              <div className="text-yellow-200 text-xs mt-1 italic font-medium">
                                Exemples : {section.content.universeExamples}
                              </div>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="space-y-3 lg:order-2">
                          ...
                          <div className="p-2 sm:p-3 rounded-lg border-l-4 bg-blue-900/40 border-blue-400 min-h-[60px] sm:min-h-[70px] flex flex-col justify-center">
                            ...
                            <div className="text-gray-300 text-xs mt-1">{section.content.application}</div>
                          </div>
                        </div>
