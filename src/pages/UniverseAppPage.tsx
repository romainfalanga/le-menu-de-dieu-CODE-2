                ...
                <div className="bg-gradient-to-br from-emerald-900/50 to-teal-900/40 backdrop-blur-sm rounded-xl p-3 sm:p-4 border-2 border-emerald-400/40 shadow-2xl mb-3 sm:mb-4">
                  ...
                  <div className="bg-gradient-to-r from-indigo-900/60 to-purple-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border-2 border-indigo-400/50 shadow-2xl mb-6">
                    ...
                    <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm lg:text-base text-gray-200 leading-relaxed">
                      ...
                      <p>
                        <strong className="text-green-300">Dans l'application :</strong> Dès l'échelle JavaScript, les composants logiciels (fonctions, variables, objets...) peuvent exister dans une superposition de plusieurs implémentations possibles. Un composant React peut potentiellement se comporter de multiples façons selon son code interne - comme s'il "passait par plusieurs chemins d'exécution à la fois" ! Leur comportement exact n'est qu'une <strong className="text-yellow-300">probabilité</strong> jusqu'à ce qu'une inspection du code "révèle" leur implémentation concrète.
                      </p>
                      <p className="font-semibold text-pink-300 bg-pink-900/20 p-2 sm:p-3 rounded-lg border border-pink-400/30">
                        💫 <strong>L'acte d'observation (physique) ou d'inspection (code)</strong> "effondre" la superposition et révèle l'état ou l'implémentation concrète. Tout comme mesurer par quelle fente passe la particule détruit les interférences quantiques, inspecter le code d'un composant révèle son implémentation unique. Dans les deux cas, regarder "sous le capot" transforme la probabilité en réalité définie.
                      </p>
                    </div>
                  </div>
